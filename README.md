<h2 align="center">Привет, я Александр<br>Frontend разработчик на React</h2>
<p align="center">
  <img src="./Jim.gif">
</p>
<h2>Мой код</h2>
<ul>
  <li>
    <h3>Open sourse</h3>
    Принимал участие в open sourse. Контрибьютор онлайн-редактора кода <a href="https://github.com/bobronaud/runit">Runit</a>.
    <br>
